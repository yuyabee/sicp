;; helper methods of interpreter
(load "./chap4/base.scm")

;; returns instruction-sequence
;; target is always the returned value of respective procedures
...
;; needs and modifies are used in compiling proccess
;; pass statements of instruction sequence to assemble
			...
			(preserving
				...
				(make-instruction-sequence '(env val) (list target)
																	 `((perform (op set-variable-value!)
																							...
																							(reg val)
																							(reg env))
																		 ;; this is what assignment returns
...
(define (append-instruction-sequences . seqs)
	(define (append-2-sequences seq1 seq2)
		(make-instruction-sequence
			;; union set of registers-needed of seq1 and diff set of registers-needed
			;; of seq2 and registers-modified of seq1
			(list-union (registers-needed seq1)
									(list-difference (registers-needed seq2)
																	 (registers-modified seq1)))
			;; union set of registers-modified of seq1 and registers-modified of seq2
...
(define (formatted-compile exp target linkage)
			...
			(begin
				(cond ((pair? (car s))
							...
							(else
								...
								(newline)))
				(output-iter (cdr s)))))
	(let ((compiled-code (compile exp target linkage)))
		(display ";; needed   : ")
